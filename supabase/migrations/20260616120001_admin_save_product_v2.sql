-- admin_save_product, rebuilt for the content-model refactor: core now carries
-- details/specifications/video_url/faqs/editorial_blocks and no longer references
-- product_type_id or specs. Everything else (options/variants/images/collections/tags)
-- is unchanged. SECURITY INVOKER — RLS remains the authorization layer.
...
begin
  ...
  if payload->>'id' is not null then
    ...
    insert into products (
      ...
      whatsapp_message_template, amazon_url, is_featured, badges, meta_title, meta_description
    ) values (
      core->>'title',
      core->>'slug',
      core->>'description',
